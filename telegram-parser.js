...
class TelegramParser {
  ...
  parseChannelInfo(html) {
    ...
    // Extract username
    channelInfo.username = $(".tgme_channel_info_header_username a")
      .text()
      .trim();
  ...
  parseSinglePost($, postElement) {
    ...
    // Extract author info
    post.author = postElement
      .find(".tgme_widget_message_owner_name span")
      .text()
      .trim();
  ...
  parseMedia($, postElement) {
    ...
    postElement.find(".tgme_widget_message_photo_wrap").each((i, elem) => {
      ...
      const photo = {
        ...
        paddingTop:
          $elem.find(".tgme_widget_message_photo").css("padding-top") || "",
      };
      media.push(photo);
    });
      ...
      const video = {
        ...
        width:
          $elem
            ...
            ?.replace("px", "") || "",
        paddingTop:
          $elem.find(".tgme_widget_message_video_wrap").css("padding-top") ||
          "",
      };
      media.push(video);
    });
